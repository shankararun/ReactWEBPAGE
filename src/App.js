    ...
    <div className="App">
      ...
      <div className={classes.wrapper}>
        <Typography variant="h4" className={classes.bigSpace} color="primary">
          At Rocket.io We are passionate in Software
        </Typography>
        <Typography variant="h5" className={classes.littleSpace} color="primary">
          We produce robust, flexible Software in rocket.io. We are globally present all across the world with our quality software
        </Typography>
      </div>  
